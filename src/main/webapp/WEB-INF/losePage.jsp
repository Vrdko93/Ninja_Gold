...
<body>
	<audio id="audio" src="https://www.soundjay.com/button/sounds/beep-05.wav" autoplay="false"></audio>
	...
	<h1 id="title">Ooops... You Lost!</h1>
	<a href="/reset">RESTART</a>
    <h3 id="winCondition"><span>Win Condition:</span> Find at least 100 gold to win!</h3>

    <img id="pour" src="https://thumbs.dreamstime.com/b/money-bag-hole-cartoon-businessman-hand-holding-losing-golden-coins-poured-out-vector-illustration-73254634.jpg" alt="">
</body>
</html>