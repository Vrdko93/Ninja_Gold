...
<body>
	<audio id="audio" src="https://www.soundjay.com/button/sounds/beep-09.wav" autoplay="false"></audio>
    ...
    <img id="pour" src="https://media1.giphy.com/media/NsAXBSpx0MJ6IBDCPY/giphy.gif" alt="">
</body>
</html>